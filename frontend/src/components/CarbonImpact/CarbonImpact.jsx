    ...
    <section className={styles.section} aria-labelledby="carbon-heading">
      ...
      <div className={styles.recommendations}>
        ...
        <ul className={styles.recList}>
          <li>🗑️ Delete unnecessary files: Reducing storage by 10% saves ~{(carbonKg * 0.1).toFixed(1)} kg CO2/year</li>
          <li>♻️ Archive old data: Move infrequently accessed data to cold storage</li>
