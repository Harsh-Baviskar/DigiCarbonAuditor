    ...
    <div className={styles.page} role="tabpanel" id="carbon-footprint-panel">
      <div className={styles.header}>
        ...
        <p className={styles.description}>
          Estimate the carbon footprint of your digital storage by analyzing file sizes and calculating CO₂ emissions based on your region's electricity carbon intensity.
        </p>
      </div>
